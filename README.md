...
│   ├── Reservation.cs
│   ├── AllocationEvent.cs                  # Immutable ledger row — EventType, OrderId, OrderLineId, SkuId, Quantity, OccurredAt; LotId (Guid?, nullable) added Phase 20 — carries the lot consumed on allocation_committed events from the lot-aware path
